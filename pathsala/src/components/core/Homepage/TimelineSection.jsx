    ...
    <div>
      <div className='flex flex-row gap-15 items-center '>
        ...
        <div className='relative shadow-blue-200'>
            <img src={timelineImage} alt='timeline img' className='shadow-white object-cover rounded-lg'></img>
            ...
            translate-y-[-50%]">
                <div className='flex gap-5 items-center border-r border-caribbeangreen-300 px-7'>
                    <p className='text3xl font-bold'>Multipel</p>
                    <p className='text-caribbeangreen-300 text-sm'>Years of Experience</p>
                </div>

                <div className="flex gap-5 items-center px-7">
                <p className='text3xl font-bold'>20+</p>
